...
public class HelloController {
	...
	public String hi(@PathVariable("name") String name,
			...
			ModelMap map) {
		map.addAttribute("msg" , "Hello To Java World");
		map.addAttribute("name" , name);
		map.addAttribute("id" , id);
		return "index";
	}

	@RequestMapping(path = "/form")  //to go to the form page
	public String formPage() {
		return "form";
	}
	
	@RequestMapping(path = "/form" , method = RequestMethod.POST)//accept the req from the controller
